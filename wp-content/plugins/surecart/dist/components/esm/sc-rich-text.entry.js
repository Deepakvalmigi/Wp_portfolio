...
const ScRichText = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (h(Host, { key: 'a69d551ec0106913126da6846a6b033f8b83c543' }, h("sc-form-control", { key: '03f00baa53901bff818c470c0c39e921dfa85844', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("div", { key: '3fd40a228751f1e96d5a0e87e9bc70bc1611c123', part: "base", class: { 'editor-base': true, 'editor--focused': this.hasFocus } }, h("div", { key: 'a556df18e19492b806676046aa89f61af50f691b', class: "menu" }, h("sc-button", { key: 'b15ef47853c679d31983dedbfba7a0443246dae9', size: "small", type: ((_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, 'bold')) ? 'default' : 'text', onClick: () => this.run('toggleBold'), disabled: !this.can('toggleBold') }, h("sc-icon", { key: '58d230e5b05e4e149bd30d54a465f862baa9d6b0', name: "bold" })), h("sc-button", { key: '3fc13819e38245b30f8074db8dbd8679944b0568', size: "small", type: ((_d = (_c = this.editor) === null || _c === void 0 ? void 0 : _c.isActive) === null || _d === void 0 ? void 0 : _d.call(_c, 'italic')) ? 'default' : 'text', onClick: () => this.run('toggleItalic'), disabled: !this.can('toggleItalic') }, h("sc-icon", { key: '0e45f01002b0b6f81567d20de3584e26e238ebb2', name: "italic" })), h("sc-button", { key: '6782692e8efe2d27c6b7d24996bbeab7baa21643', size: "small", type: ((_f = (_e = this.editor) === null || _e === void 0 ? void 0 : _e.isActive) === null || _f === void 0 ? void 0 : _f.call(_e, 'bulletList')) ? 'default' : 'text', onClick: () => this.run('toggleBulletList') }, h("sc-icon", { key: '7e7347ad9e42a4d05b3151270f40acdf21a8aa60', name: "list" })), h("sc-button", { key: 'bfaca8b63b6afdecc99083ac8ea0b2f5e75122d4', size: "small", type: ((_h = (_g = this.editor) === null || _g === void 0 ? void 0 : _g.isActive) === null || _h === void 0 ? void 0 : _h.call(_g, 'strike')) ? 'default' : 'text', onClick: () => this.run('toggleStrike') }, h("sc-icon", { key: 'b0f0ee9ee42f6834fb6edab8ff655ec7a1375f6d', name: "minus" })), h("sc-button", { key: '8d6f9a08939eb44ff122b6074a1f96e7be30d7f6', class: "right", size: "small", type: "text", onClick: () => this.run('undo'), disabled: !this.can('undo') }, h("sc-icon", { key: '342f786befd930fe6a77767e95aafc89d6ebdecf', name: "corner-up-left" })), h("sc-button", { key: 'fd5f3d2f9a35ffd8a728fa5a580e2e4f1495c68e', size: "small", type: "text", onClick: () => this.run('redo'), disabled: !this.can('redo') }, h("sc-icon", { key: '5d64d5a61e6b42830401580e2a2c91c0e9ab00da', name: "corner-up-right" }))), h("div", { key: '18e12f8fee4678d5c5b71e583c192d7c69d77ed5', part: "editor", class: {
                editor: true,
            }, ref: el => (this.element = el) })), this.remainingCharacters() < 20 && h("div", { key: '9d295c18ada03355a49a3a860bbd091fce01ed25', class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.remainingCharacters())))));
    }
};
